...
`axlDllCall( o_pluginFunc [g_arg1] ... [g_arg10] ) => nil/x_value/lg_data`
...
`_ashEcho = axlDllSym(_ashTestDll "ashEcho") axlDllCallList(_ashEcho list(-1 -2.0 nil "another string" -10.1:-2 0.2))`
...
DLL Programming `,`axlDllSym`,`axlDllCall`,`axlDllCallListaxlDllClose`,`axlDllDump

### axlDllSym

`axlDllSym( o_plugin t_symbolName ) => o_pluginFunc/nil`
