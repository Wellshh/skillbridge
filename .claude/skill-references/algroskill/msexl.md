...
`axlSpreadsheetInit() ==> t axlSpreadsheetSetWorksheet("First") ==> t axlSpreadsheetDefineCell(1 1 "Default" "String" "Hello") ==> t axlSpreadsheetWrite("example.xml") ==> t axlSpreadsheetClose() ==> t` axlSpreadsheetInit, axlSpreadsheetRead, axlSpreadsheetWrite
...
| Name | Description |
|---|---|
| x_`row` | Row index (1-based) for the desired cell. |
| x_`col` | Column index (1-based) for the desired cell. |
| t_`style` | Style name to apply to this cell / nil for default. |
| t_`type` | Type definition for this cell / nil for default (string). |
...
`axlSpreadsheetDefineCell(1 1 "Default" "String" "Hello") ==> t` axlSpreadsheetGetCell, axlSpreadsheetSetCell, axlSpreadsheetSetCellProp
...
`axlSpreadsheetRead("example.xml") ==> t axlSpreadsheetSetWorksheet("First") ==> t g_cell = axlSpreadsheetGetCell(1 1) g_cell->?? ==> (column 4 row 1 data "a" type "String" style "Default" ) axlSpreadsheetClose() ==> t` axlSpreadsheetSetCell, axlSpreadsheetSetCellProp, axlSpreadsheetDefineCell
...
`axlSpreadsheetGetRGBColorString(255 0 0) ==> "#ff0000"` axlSpreadsheetGetRGBColorString
...
`axlSpreadsheetGetRGBForNamedColor("cyan") ==> "#00FFFF"` axlSpreadsheetGetRGBColorString
...
`axlSpreadsheetRead("example.xml") ==> t axlSpreadsheetGetStyles() ==> (("Default" "DEFAULT") ("Title" "TITLE") ("Data" "DATA")) axlSpreadsheetClose() ==> t` axlSpreadsheetSetWorksheet
...
`axlSpreadsheetRead("example.xml") ==> t axlSpreadsheetGetWorksheets() ==> ("First" "Second") axlSpreadsheetClose() ==> t` axlSpreadsheetSetWorksheet
...
`axlSpreadsheetRead("example.xml") ==> t axlSpreadsheetSetWorksheet("First") ==> t axlSpreadsheetGetWorksheetSize() ==> (5 5) axlSpreadsheetClose() ==> t` axlSpreadsheetSetWorksheet
...
`axlSpreadsheetInit() ==> t axlSpreadsheetSetWorksheet("First") ==> t axlSpreadsheetDefineCell(1 1 "Default" "String" "Hello") ==> t axlSpreadsheetWrite("example.xml") ==> t axlSpreadsheetClose() ==> t` axlSpreadsheetClose, axlSpreadsheetRead, axlSpreadsheetWrite
...
`axlSpreadsheetGetCell(1 1) ... axlSpreadsheetClose() ==> t`
...
`axlSpreadsheetSetCell(1 1) ==> t axlSpreadsheetSetCellProp("VALUE" "New Value") ==> t` axlSpreadsheetSetCell, axlSpreadsheetGetCell, axlSpreadsheetDefineCell
...
`axlSpreadsheetSetRowProp(1 "AUTO_WIDTH" "1")` axlSpreadsheetSetRowProp
...
`axlSpreadsheetInit() ==> t axlSpreadsheetSetDocProp("AUTHOR" "John") ==> t axlSpreadsheetSetDocProp("AUTHOR" "Doe") ==> t axlSpreadsheetWrite("example.xml") ==> t axlSpreadsheetClose() ==> t` Sets a property for the given row of the active worksheet.
...
| `t_propName` | Property to set. Allowable properties are, AUTO_HEIGHT, HEIGHT, and STYLE.
 Values supported for these properties are:
 AUTO_HEIGHT -- Boolean value (0 or 1)
 HEIGHT -- Positive integer value in font points
 STYLE -- Style ID name currently defined in active document |
| `t_propVal` | Value to set this property to.
 AUTO_HEIGHT -- Boolean value (0 or 1)
 HEIGHT -- Positive integer value in font points
...
`axlSpreadsheetSetRowProp(1 "AUTO_HEIGHT" "1")` axlSpreadsheetSetColumnProp
...
`axlSpreadsheetSetStyle("Default" nil) ==> t axlSpreadsheetSetStyleProp("Alignment" "Vertical" "Top") ==> t` axlSpreadsheetSetCell, axlSpreadsheetSetWorksheet
...
`axlSpreadsheetSetStyle("Second" "Second Style") ==> t axlSpreadsheetSetStyleParent("Default") ==> t axlSpreadsheetSetStyleBorder("Left" nil "Continuous" "2") ==> t axlSpreadsheetSetStyleBorder("Right" nil "Continuous" "2") ==> t axlSpreadsheetSetStyleBorder("Top" nil "Continuous" "2") ==> t axlSpreadsheetSetStyleBorder("Bottom" nil "Continuous" "2") ==> t` axlSpreadsheetSetStyle, axlSpreadsheetSetStyleProp, axlSpreadsheetSetStyleParent, axlSpreadsheetGetRGBColorString
...
`axlSpreadsheetSetStyle("Second" "Second Style") ==> t axlSpreadsheetSetStyleParent("Default") ==> t axlSpreadsheetSetStyleProp("Alignment" "Horizontal" "Center") ==> t` axlSpreadsheetSetStyle, axlSpreadsheetSetStyleBorder, axlSpreadsheetSetStyleProp
...
Table 27-3 
 NUMBER_FORMAT properties and values supported
...
`axlSpreadsheetSetStyle("Second" "Second Style") ==> t axlSpreadsheetSetStyleParent("Default") ==> t axlSpreadsheetSetStyleProp("Alignment" "Horizontal" "Center") ==> t` axlSpreadsheetSetStyle, axlSpreadsheetSetStyleBorder, axlSpreadsheetSetStyleParent, axlSpreadsheetGetRGBColorString
...
`axlSpreadsheetInit() ==> t axlSpreadsheetSetWorksheet("First") ==> t axlSpreadsheetDefineCell(1 1 "Default" "String" "Hello") ==> t axlSpreadsheetWrite("example.xml") ==> t axlSpreadsheetClose() ==> t` axlSpreadsheetClose, axlSpreadsheetInit, axlSpreadsheetRead
