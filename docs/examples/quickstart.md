...
Start python_server.il in Allegro before running this notebook. The default workspace is 7777 on Windows and default on Unix. Set ALLEGROBRIDGE_WORKSPACE_ID when your server uses another id.
