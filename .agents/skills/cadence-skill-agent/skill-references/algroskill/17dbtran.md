...
| Name | Description |
|---|---|
| `g_undoMark` | This should be set to 'undoMark that are for commands that want multiple undo events. For example, place multiple individual symbols, you may want each placement to be an indivdual undo event.
